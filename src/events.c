...
/*   Updated: 2025/04/13 11:01:53 by anavas-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handle_keypress(int keysym, t_global *global)
{
	...
	{
		finish(global, SUCCESS); // Usar finish en lugar de close_window
		return (0); // Esta línea nunca se ejecutará si finish llama a exit()
	}
